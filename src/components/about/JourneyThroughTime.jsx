...
const TimelineCard = ({
  ...
  <article className="w-full max-w-[260px] lg:max-w-[200px] xl:max-w-[270px] 2xl:max-w-[320px] 3xl:max-w-[380px] 4xl:max-w-[480px] 5xl:max-w-[680px] mx-auto bg-white border border-on-light-stroke flex flex-col min-h-[290px] lg:min-h-[215px] xl:min-h-[290px] 2xl:min-h-[345px] 3xl:min-h-[410px] 4xl:min-h-[520px] 5xl:min-h-[740px]">
    ...
    <div className="flex-1 px-4 py-4 lg:px-3 lg:py-3 xl:px-4 xl:py-4 2xl:px-5 2xl:py-5 3xl:px-6 3xl:py-6 4xl:px-8 4xl:py-8 5xl:px-11 5xl:py-11">
      <p className="font-medium text-[14px] lg:text-[11px] xl:text-[13px] 2xl:text-[15px] 3xl:text-[17px] 4xl:text-[21px] 5xl:text-[30px] text-on-light-black mb-1 lg:mb-0">
        {year}
      </p>
      <p className="text-[12.5px] lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] 4xl:text-[20px] 5xl:text-[28px] text-on-light-grey leading-[1.55]">
        {caption}
      </p>
    </div>
  </article>
...
const JourneyThroughTime = () => {
  return (
    <>
      <RaggedyDivider />
      <section className="bg-pastel-brown-bg pt-2 px-6 lg:px-10 xl:px-12 2xl:px-14 3xl:px-16 4xl:px-20 5xl:px-28">
        <div className="text-center lg:-mt-[120px] lg:min-h-[150px] lg:flex lg:flex-col lg:items-center lg:justify-center xl:-mt-[160px] xl:min-h-[300px] 2xl:-mt-[200px] 2xl:min-h-[360px] 3xl:-mt-[240px] 3xl:min-h-[440px] 4xl:-mt-[320px] 4xl:min-h-[560px] 5xl:-mt-[460px] 5xl:min-h-[800px]">
          <h2 className="font-normal text-[40px] lg:text-[36px] xl:text-[56px] 2xl:text-[64px] 3xl:text-[76px] 4xl:text-[96px] 5xl:text-[136px] leading-[1.2] -tracking-[1px] text-on-light-black">
            A journey through time
          </h2>
          <img
            src="/about/shaping-a-legacy.svg"
            alt="shaping a legacy of innovation"
            className="mx-auto mt-3 h-6.5 lg:h-7 xl:h-10 2xl:h-11 3xl:h-13 4xl:h-16 5xl:h-22 w-auto"
          />
        </div>

        <div className="relative max-w-[1080px] lg:max-w-[850px] xl:max-w-[1240px] 2xl:max-w-[1440px] 3xl:max-w-[1700px] 4xl:max-w-[2150px] 5xl:max-w-[3200px] mx-auto">
          <div className="grid grid-cols-12 gap-4 lg:gap-12 xl:gap-25 2xl:gap-32 3xl:gap-40 4xl:gap-50 5xl:gap-72">
