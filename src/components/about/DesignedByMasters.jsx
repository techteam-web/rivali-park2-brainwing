...
const DesignedByMasters = () => {
  return (
    <>
      <RaggedyDivider />
      <section className="bg-pastel-brown-bg pt-2 pb-24 lg:pb-20 xl:pb-24 2xl:pb-28 3xl:pb-32 4xl:pb-40 5xl:pb-56 px-6 lg:px-[10%] xl:px-[10%] 2xl:px-[10%] 3xl:px-[10%] 4xl:px-[10%] 5xl:px-[10%]">
        <div className="max-w-[1180px] lg:max-w-none xl:max-w-none 2xl:max-w-none 3xl:max-w-none 4xl:max-w-none 5xl:max-w-none mx-auto">
          <div className="grid grid-cols-12 gap-6 lg:gap-8 xl:gap-10 2xl:gap-12 3xl:gap-14 4xl:gap-18 5xl:gap-24 items-end mb-14 lg:mb-16 xl:mb-20 2xl:mb-24 3xl:mb-28 4xl:mb-36 5xl:mb-52">
            <div className="col-span-12 lg:col-span-7">
              <h2 className="font-normal text-[36px] lg:text-[34px] xl:text-[48px] 2xl:text-[58px] 3xl:text-[66px] 4xl:text-[92px] 5xl:text-[138px] leading-[1.16] -tracking-[0.5px] text-on-light-black">
                Designed By Masters
              </h2>
              <img
                src="/about/inspired-by-life.svg"
                alt="inspired by life"
                className="mt-3 h-6.5 lg:h-5.5 xl:h-8 2xl:h-9 3xl:h-11 4xl:h-15 5xl:h-22 w-auto"
              />
              <p className="text-on-light-black/85 text-[13px] lg:text-[10.5px] xl:text-[15px] 2xl:text-[18px] 3xl:text-[19px] 4xl:text-[26px] 5xl:text-[38px] leading-[1.85] mt-7 lg:mt-5 xl:mt-7 2xl:mt-8 3xl:mt-9 4xl:mt-12 5xl:mt-16 max-w-[600px] 4xl:max-w-[760px] 5xl:max-w-[1080px]">
            ...
            <div className="col-span-12 lg:col-span-5 flex lg:justify-end">
              <img
                ...
                alt=""
                aria-hidden="true"
                className="block w-full max-w-105 lg:max-w-[260px] xl:max-w-[400px] 2xl:max-w-[480px] 3xl:max-w-[580px] 4xl:max-w-[800px] 5xl:max-w-[1180px] h-auto"
              />
            </div>
          </div>
