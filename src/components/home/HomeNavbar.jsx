    ...
    >
      ...
      >
        ...
        {items.map((item) => {
          ...
          const content = (
            <span className="relative z-10 flex items-center gap-1.5 xl:gap-2 3xl:gap-2.5 4xl:gap-3 5xl:gap-4 text-on-light-black transition-[color] duration-400 ease-out group-hover:text-white">
