...
// Shared with LocationsCanvas. Mounted inside the Suspense boundary below, so it
// only ticks once TextureProvider's textures have resolved and the depth shader
// has compiled. The detail view waits for it before playing its reveal, so the
// entrance never runs against that stall (which is what looked glitchy).
